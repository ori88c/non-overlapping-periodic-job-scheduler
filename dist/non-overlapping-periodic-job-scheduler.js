...
class NonOverlappingPeriodicJobScheduler {
     ...
     */
    constructor(_periodicJob, _computeNextDelay) {
        this._periodicJob = _periodicJob;
        this._computeNextDelay = _computeNextDelay;
    ...
    async start() {
        ...
        this._status = 'active';
        const syntheticPreviousExecutionMetadata = {
            durationMs: types_1.NO_PREVIOUS_EXECUTION,
        };
